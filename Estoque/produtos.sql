...
AS
    BEGIN
          declare @id_produto int,
            ...
            SELECT @id_produto = id, @quantidadeProduto = quantidade, @dataEntrada = ultima_data_entrada from inserted


            insert into hist_Entrada(id_produto,quantidade,data_entrada) VALUES
              (@id_produto,@quantidadeProduto,@dataEntrada)
